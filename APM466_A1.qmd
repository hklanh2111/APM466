...
\item \hfill
  \begin{enumerate}
  \item
Governments issue bonds instead of printing money to prevent the risk of inflation, becauseincreasing money supply can reduce the value of money. Issuing bonds allows governments toborrow money to finance government spending without immediately increasing money supply.
  \item
A flattening of the long-term part of a yield curve is usually a sign of economic uncertainty.  Investors may purchase more long-term bonds and drive down long-term yields because they anticipate slower economic growth or lower inflation in the future.

  \item
Quantitative easing is a monetary policy in which a central bank purchases big amount of financial assets in order to push down long-term interest rates and boost economic activity. During the COVID-19 pandemic, the U.S. Federal Reserve implemented QE by acquiring Treasury bonds and mortgage-backed securities to calm financial markets and boost economic recovery.
  \end{enumerate}
...
\end{tabular}
\end{center}
They are all Government of Canada bonds with semi-annual coupon payments, which makes it easier to compare them and construct the yield, spot, and forward curves. Semi-annual coupons provide more cashflow points over time, which helps smooth the curve over the 0--5 year maturity range. They are also frequently traded, so prices are more reliable and consistent for plotting.
...
&bondtype=2%2c3%2c4%2c16&coupon=&currency=184&rating=&country=19}
\item
Wessel, D., \& Milstein, E. (2024, January 2). What did the Fed do in response to the COVID-19 crisis? Brookings. \url{https://www.brookings.edu/articles/fed-response-to-covid19/}
\item
Chen, J. (2025, October 22). Understanding flat yield curves: Impacts on investors and strategies. Investopedia. \url{https://www.investopedia.com/terms/f/flatyieldcurve.asp}
\item
